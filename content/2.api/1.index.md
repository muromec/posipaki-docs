...
See [Plugins](/plugins/). Plugins are inherited by all children by default. When child actor defines their plugins as an array, they will be added to the list of plugins passed by parent and deduplicated on name.
...
See [Parent-Child](/parent-child/) page to learn more about orphan processes.
