...
- **Portable.** The core runs anywhere JavaScript does — browser, service workers, Node, Bun.
- **Distributed.** Spawn children in a different process on node, a worker in a browser, or bridge both with WebSocket.
